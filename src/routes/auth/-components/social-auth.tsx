      ...
      <div>
        <div className="grid grid-cols-2 gap-4">
          <Button
            ...
            className={cn(
              'hidden',
              'custom' in authProviders && 'inline-flex'
            )}>
            <VaultIcon />
      ...
      <Dialog
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <Form {...packtechForm}>
            <form
              className="space-y-6"
              onSubmit={packtechForm.handleSubmit(handlePacktechLogin)}>
              <FormField
                  ...
                  <FormItem>
                    ...
                    <div className="flex items-center gap-x-1.5">
                      ...
                      <Button
                        ...
                        size="icon"
                        variant="ghost"
                        onClick={toggleShowPacktechPassword}>
              ...
              <DialogFooter>
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => setIsPacktechDialogOpen(false)}>
                  <Trans>Cancel</Trans>
                </Button>
                <Button
                  type="submit"
                  disabled={packtechForm.formState.isSubmitting}>
                  <Trans>Sign in</Trans>
                </Button>
              </DialogFooter>
            </form>
